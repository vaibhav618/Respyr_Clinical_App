...
class ScoreCard extends StatelessWidget {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20,),
            Text(ScoreStatusHelper.getScoreTitle(score),
              style: GoogleFonts.poppins(
  ...
  String scoreIcon(String scoreName){
    switch(scoreName){
      case("Sugar score") : return ResSvg.sugarPancreas;
      case("Respiratory score") : return ResSvg.respiratory;
      case("Liver score") : return ResSvg.liver;
      case("Gut score") : return ResSvg.gutVital;
      default : return ResSvg.sugarPancreas;
    }
  }
}
