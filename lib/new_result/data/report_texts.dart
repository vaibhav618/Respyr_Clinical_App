/// The result's disclaimer and regulatory-status text, verbatim.
///
/// One source for both the screen (disclaimer_card.dart) and the PDF report —
/// regulatory wording on a Class B device must not drift between the two.
library;
...
const List<String> kRegulatoryBullets = [
